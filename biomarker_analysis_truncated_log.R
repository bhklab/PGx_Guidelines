# biomarker analysis - excluding non-solid tissues and truncated and log2 on ic50
...
biomarker_truncated_log <- do.call("rbind", list(lap, doc, pic, gem, vor, pac, cri, erl))
WriteXLS::WriteXLS(biomarker_truncated_log, "../results/biomarker_truncated_log.xls")
