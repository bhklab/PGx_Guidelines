...
col_pr = "NonSolidAll_GDSC_Pearson"
col_sp = "NonSolidAll_GDSC_Spearman"
col_rmse = "NonSolidAll_GDSC_RMSE"
...
for drug in drugs:
    ...
    for it in range(10):
        ...
        idx_ctrp = [x for x in idx_ctrp if x in idx_other_ctrp]
    ...
    df_NonSolid.loc[drug,col_pr] = np.mean(save_pr)
    df_NonSolid.loc[drug,col_sp] = np.mean(save_sp)
    df_NonSolid.loc[drug,col_rmse] = np.mean(save_rmse)
    
    
col_pr = "NonSolidAll_gCSI_Pearson"
col_sp = "NonSolidAll_gCSI_Spearman"
col_rmse = "NonSolidAll_gCSI_RMSE"
...
col_pr = "NonSolidSolid_GDSC_Pearson"
col_sp = "NonSolidSolid_GDSC_Spearman"
col_rmse = "NonSolidSolid_GDSC_RMSE"
...
col_pr = "NonSolidSolid_gCSI_Pearson"
col_sp = "NonSolidSolid_gCSI_Spearman"
col_rmse = "NonSolidSolid_gCSI_RMSE"
...
col_pr = "NonSolidNonSolid_GDSC_Pearson"
col_sp = "NonSolidNonSolid_GDSC_Spearman"
col_rmse = "NonSolidNonSolid_GDSC_RMSE"
...
col_pr = "NonSolidNonSolid_gCSI_Pearson"
col_sp = "NonSolidNonSolid_gCSI_Spearman"
col_rmse = "NonSolidNonSolid_gCSI_RMSE"
...
df_NonSolid.to_csv('NonSolid_Results.csv')            
