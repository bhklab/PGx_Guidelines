# biomarker analysis - excluding non-solid tissues 
...
biomarker_solidonly <- do.call("rbind", list(lap, doc, pic, gem, vor, pac, cri, erl))
WriteXLS::WriteXLS(biomarker_solidonly, "../results/biomarker_solidonly.xls")
